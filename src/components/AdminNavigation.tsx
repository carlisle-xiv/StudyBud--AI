      ...
      <div className="w-64 bg-white shadow-lg flex flex-col">
        ...
        <div className="p-4 border-t border-gray-200">
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-left transition-all duration-200 text-gray-700 hover:bg-red-50 hover:text-red-600 group"
          >
