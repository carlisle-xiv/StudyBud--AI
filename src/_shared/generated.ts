...
export function postLoginWithGoogle(args: { variables: LoginWithGoogleInput; headers:Headers; }){
	return apiPost<VerifiedUserLogin, LoginWithGoogleInput>({path: "/login", variables:args.variables, headers: args.headers });}
export function useLoginWithGoogleMutation(options?:UseMutationOptions<ApiRequestResult<VerifiedUserLogin>, AxiosError<ServerErrorResponse<unknown>>, {headers:Headers; variables:LoginWithGoogleInput}>){
...
export function postVerifyEmail(args: { variables: VerifyEmailInput; headers:Headers; }){
	return apiPost<VerifiedEmail, VerifyEmailInput>({path: "/verifyEmail", variables:args.variables, headers: args.headers });}
export function useVerifyEmailMutation(options?:UseMutationOptions<ApiRequestResult<VerifiedEmail>, AxiosError<ServerErrorResponse<unknown>>, {headers:Headers; variables:VerifyEmailInput}>){
...
export function postVerifyOtp(args: { variables: VerifyOtpInput; headers:Headers; }){
	return apiPost<VerifiedUserLogin, VerifyOtpInput>({path: "/verifyOtp", variables:args.variables, headers: args.headers });}
export function useVerifyOtpMutation(options?:UseMutationOptions<ApiRequestResult<VerifiedUserLogin>, AxiosError<ServerErrorResponse<unknown>>, {headers:Headers; variables:VerifyOtpInput}>){
...
export function postRefreshToken(args: { variables: RefreshAccessTokenInput; headers:Headers; }){
	return apiPost<VerifiedUserLogin, RefreshAccessTokenInput>({path: "/refreshToken", variables:args.variables, headers: args.headers });}
export function useRefreshTokenMutation(options?:UseMutationOptions<ApiRequestResult<VerifiedUserLogin>, AxiosError<ServerErrorResponse<unknown>>, {headers:Headers; variables:RefreshAccessTokenInput}>){
